      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
          <div className="flex h-full">
            {/* Left panel with 9:16 aspect ratio image */}
            <div className="flex-1 h-full flex items-center justify-start">
              <div className="relative" style={{ aspectRatio: '12 / 12', height: '60vh' }}>
            <div className="relative w-full h-full overflow-hidden rounded-lg shadow-2xl">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center z-10">
                    <div className="text-center px-6 max-w-xs">
                      <div className="mb-4">
                        <span className="inline-block px-2 py-1 bg-white/20 backdrop-blur-sm rounded-full text-white/90 text-xs font-medium">
